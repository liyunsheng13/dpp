...
from .fpn_mb import FeaturePyramidNetwork, LastLevelMaxPool
...
class BackboneWithFPN(nn.Module):
    ...
    def __init__(self, backbone, return_layers, in_channels_list, out_channels, extra_blocks=None):
        ...
        self._out_feature_strides = {'0':16, '1':32, 'pool':64}
        self._out_features = ['0','1','pool']
...
def mobilenet_backbone(
    ...
    stage_indices = [0] + [i-1 for i, b in enumerate(backbone) if getattr(b, "_is_cn", False)] + [len(backbone) - 1]
